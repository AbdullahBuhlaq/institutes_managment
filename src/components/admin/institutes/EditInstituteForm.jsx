...
function EditInstituteForm(props) {
  ...
  const [institute, setInstitute] = useState({
    ...
    nameCenter: props.currentEdit.name,
  ...
  async function editInstitute(event) {
    ...
    const url = props.type == "center" ? `http://localhost:3001/admin-training/my-center/update` : `http://localhost:3001/admin-training/my-center/update`;
    ...
    if (data.success) {
      console.log(data);
      props.type == "center" ? props.setInstitute({ ...props.institute, name: newData.nameCenter, ...newData }) : props.setInstitutes({ ...props.institutes, [id]: { ...props.institutes[id], name: newData.nameCenter, ...newData } });
