    ...
    <>
      <div className="page-content">
        ...
        <div className="content-categories">
          ...
          {checkPermissions(props.userInformation, ["admin_training.role.add", "admin_training.role.all"], [], -1) ? (
            <div
        ...
        {currentEdit && <RoleItem toast={props.toast} currentEdit={currentEdit} deleteRole={deleteRole} roles={props.roles} setRoles={props.setRoles} permission={trainingPermission} show={selectOptions.showIns} url={url} userInformation={props.userInformation} />}
        {addNew && <AddRoleForm toast={props.toast} roles={props.roles} setRoles={props.setRoles} permission={trainingPermission} show={selectOptions.showIns} url={url} setCurrentEdit={setCurrentEdit} userInformation={props.userInformation} />}
      </div>
    </>
  );
}
