...
function Notebooks(props) {
  ...
  async function deleteNotebook(id) {
    const response = await fetch(`${process.env.REACT_APP_URL_STRING}/admin-training/notebook/delete/${id}`, { ...requestOptions, method: "delete", headers: { ...requestOptions.headers, authorization: props.userInformation.token } });
