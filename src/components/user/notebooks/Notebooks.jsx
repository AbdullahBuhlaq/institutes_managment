...
function Notebooks(props) {
  ...
  async function deleteNotebook(id) {
    const response = await fetch(`http://localhost:3001/admin-training/notebook/delete/${id}`, { ...requestOptions, method: "delete", headers: { ...requestOptions.headers, authorization: props.userInformation.token } });
