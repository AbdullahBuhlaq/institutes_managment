...
function Teachers(props) {
  ...
  async function deleteTeacher(id) {
    const response = await fetch(`${process.env.REACT_APP_URL_STRING}/admin-training/teacher/delete/${id}`, { ...requestOptions, headers: { ...requestOptions.headers, authorization: props.userInformation.token }, method: "delete" });
