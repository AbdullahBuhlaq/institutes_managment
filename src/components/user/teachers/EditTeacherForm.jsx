...
function AddTeacherForm(props) {
  ...
  async function addTeacher(event) {
    ...
    setDuringAdd(true);
    const response = await fetch(props.userInformation.branch ? `${import.meta.env.VITE_URL}/admin-training/teacher/update-in-branch/${id}` : `${import.meta.env.VITE_URL}/admin-training/teacher/update/${id}`, infoRequestOptions);
