...
function Discounts(props) {
  ...
  async function deleteDiscount(id) {
    const response = await fetch(`http://localhost:3001/admin-training/discount/delete-in-branch/${id}`, { ...requestOptions, method: "delete", headers: { ...requestOptions.headers, authorization: props.userInformation.token } });
