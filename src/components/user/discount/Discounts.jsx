...
function Discounts(props) {
  ...
  async function deleteDiscount(id) {
    const response = await fetch(props.userInformation.branch ? `${import.meta.env.VITE_URL}/admin-training/discount/delete/${id}` : `${import.meta.env.VITE_URL}/admin-training/discount/delete-in-branch/${id}`, { ...requestOptions, method: "delete", headers: { ...requestOptions.headers, authorization: props.userInformation.token } });
