...
function Rooms(props) {
  ...
  async function deleteRoom(id) {
    // const response = await fetch(`${import.meta.env.VITE_URL}/admin-training/room/delete/${id}`, { ...requestOptions, method: "delete", headers: { ...requestOptions.headers, authorization: props.userInformation.token } });
